...
class ModelBooking extends CI_Model
{
    ...
    public function joinOrder($where)
    {
        ...
        $this->db->join('mobil mo ', 'mo.id=d.id_mobil');
        $this->db->where($where);
        return $this->db->get();
    }
    ...
    {
        $sql = "INSERT INTO booking_detail (id_booking,id_mobil) SELECT booking.id_booking,temp.id_mobil FROM booking, temp WHERE temp.id_user=booking.id_user AND booking.id_user='$where'";
        $this->db->query($sql);
    }
    ...
    public function find($where)
    {
        ...
        $this->db->limit(1);
        return $this->db->get('mobil', $where);
    }
    ...
    {
        $this->db->query('CREATE TABLE IF NOT EXISTS temp(id_booking varchar(12), tgl_booking DATETIME, email_user varchar(128), id_mobil int)');
    }
    ...
    public function selectJoin()
    {
        ...
        $this->db->join('mobil', 'booking_detail.id_mobil=mobil.id');
        return $this->db->get();
    }
