            ...
            <div class="register-right">
                ...
                <div class="form-content">
                    <div class="contentForm">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, laborum voluptates! Maiores vitae tempora dolore?</p>
            ...
            <div class="register-left">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <table>
                        ...
                        <tr>
                            <td colspan="2" class="button"> <button name="register">Daftar</button></td>
                        </tr>
                    </table>
                </form>
            </div>
            <div class="register-right">
                ...
                <div class="form-content">
                    <div class="contentForm">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, laborum voluptates! Maiores vitae tempora dolore?</p>
                        <a href="" class="keterangan-form-register">Login</a>
                    </div>
    ...
    <div class="background" id="1">
        <nav id="navbar">
            ...
            <div class="profile">
                ...
                <div class="logout">
                    <h1>Nama user</h1>
                    <span><a href="session-delete.php">Logout</a></span>
                </div>
            </div>
            ...
            <div class="content1">
                <div class="maincontent">
                    ...
                    <p class="belum-muncul3">
                        ...
                        aperiam ad cumque est aliquid sint. Perferendis dicta laboriosam
                        odit consequuntur sint optio eveniet ratione iure! Veritatis
                        reiciendis accusamus suscipit sed totam eaque vero ad beatae odit
                        neque minima, laboriosam cum mollitia quas ipsa qui officia
                        obcaecati aut aliquam, soluta ab?
                    </p>
                    <br />
                    <div class="button">
                        <a href="">Detail</a>
        ...
        <div class="car-content">
            <?php foreach ($mobil as $mobil) : ?>
                <div class="card hilang">
                    <header>
                        <img src="<?= base_url(); ?>assets/img/car/<?= $mobil->gambar ?>" alt="" />
                    </header>
                    <div class="content">
    ...
    <div class="subscribe" id="3">
        <div class="container-subscribe">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Perferendis deleniti <br>
                ratione architecto iusto voluptates corrupti, autem laudantium temporibus numquam repudiandae?</p>
            ...
            <div class="keterangan">
                <div class="keterangan-box">
                    ...
                    <keterangan class="keterangan-content">
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium rerum est repellendus laborum neque. Id cum voluptates assumenda libero excepturi?
                        </p>
                    </keterangan>
                </div>
                ...
                <div class="keterangan-box">
                    ...
                    <keterangan class="keterangan-content">
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga reprehenderit sint quibusdam itaque? Eaque facilis dolore qui deleniti? Eius, eos.
                        </p>
                    </keterangan>
                </div>
                ...
                <div class="keterangan-box">
                    ...
                    <keterangan class="keterangan-content">
                        <p>
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sed deserunt dolorum doloribus expedita amet! Omnis error magnam quae nisi quasi.
                        </p>
                    </keterangan>
                </div>
        ...
        <div class="content-3">
            ...
            <div class="footer-text">
                <div class="footer-text1">
                    <div class="logo">
                        <h1>NEROSTORE</h1>
                        <h5>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod nulla corporis molestiae dolores praesentium voluptas molestias ab ipsam est placeat!</h5>
                    </div>
                </div>
